...
public class Rectangle extends Figure {
    ...
    public boolean isIntersects(Rectangle rectangle) {
        ...
        return !(pRectangleLeftTop.getY() > rectangle.pRectangleRightBottom.getY() || pRectangleRightBottom.getY() < rectangle.pRectangleLeftTop.getY() ||
                pRectangleRightBottom.getX() < rectangle.pRectangleLeftTop.getX() || pRectangleLeftTop.getX() > rectangle.pRectangleRightBottom.getX());
    }
    ...
    public boolean equals(Object o) {
        ...
        return color == rectangle.color &&
                Objects.equals(pRectangleLeftTop, rectangle.pRectangleLeftTop) &&
                Objects.equals(pRectangleRightBottom, rectangle.pRectangleRightBottom);
    }

    @Override
    public int hashCode() {
        return Objects.hash(pRectangleLeftTop, pRectangleRightBottom, color);
    }
}
