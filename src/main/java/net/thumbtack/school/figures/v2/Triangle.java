...
public class Triangle extends Figure {
    ...
    public boolean isInside(int x, int y) {
        ...
        return twoPointOfLine(pTrianglePoint1, pTrianglePoint2, pTrianglePoint3, point) &&
                ...
                twoPointOfLine(pTrianglePoint3, pTrianglePoint1, pTrianglePoint2, point) == true;
    }
...
//    методы equals и hashCode.
    ...
    public boolean equals(Object o) {
        ...
        return color == triangle.color &&
                Objects.equals(pTrianglePoint1, triangle.pTrianglePoint1) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pTrianglePoint1, pTrianglePoint2, pTrianglePoint3, color);
    }
}
